...
class Machine(models.Model):
	...
	repair_shop = models.ForeignKey(RepairShop, null = True)
	...
	hitch_capacity = models.IntegerField(null = True)
	hitch_category = models.IntegerField(choices = HITCH_CHOICES, null = True)
	drawbar_category = models.IntegerField(choices = DRAWBAR_CHOICES, null = True)
	speed_range_min = models.FloatField(blank = True, null = True)
	speed_range_max = models.FloatField(blank = True, null = True)
	year_purchased = models.IntegerField(null = True)
	engine_hours = models.IntegerField(null = True)
	service_interval = models.IntegerField(null = True)
