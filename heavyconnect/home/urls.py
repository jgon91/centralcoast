...
urlpatterns = [
    ...
    url(r'^updateEquipmentNotes/$', main_views.updateEquipmentNotes, name='updateEquipmentNotes'),
    ...
    url(r'^updateSignature/$', main_views.updateSignature, name = 'updateSignature'),
